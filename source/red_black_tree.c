...
rb_red_blk_tree* RBTreeCreate( int (*CompFunc) (const void*,const void*),
  ...
  newTree=(rb_red_blk_tree*) private_malloc(sizeof(rb_red_blk_tree));
  ...
  temp=newTree->nil= (rb_red_blk_node*) private_malloc(sizeof(rb_red_blk_node));
  temp->parent=temp->left=temp->right=temp;
  temp->red=0;
  temp->key=0;
  temp=newTree->root= (rb_red_blk_node*) private_malloc(sizeof(rb_red_blk_node));
...
rb_red_blk_node * RBTreeInsert(rb_red_blk_tree* tree, void* key, void* info) {
  ...
  x=(rb_red_blk_node*) private_malloc(sizeof(rb_red_blk_node));
  x->key=key;
  x->info=info;
...
void RBTreeDestroy(rb_red_blk_tree* tree) {
  ...
  private_free(tree->root);
  private_free(tree->nil);
  private_free(tree);
}
...
/*  FUNCTION:  RBGENode */
/**/
/*    INPUTS:  tree is the tree to look for the first key >= q */
/*             with respect to the Compare function */
/**/
/*    OUTPUT:  first node in order that has key >= q */
/**/
/*    Modifies Input: none */
/***********************************************************************/
...
rb_red_blk_node* RBGENode(rb_red_blk_tree* tree, const void* q) {
  ...
  if ( lastBest == nil) return(nil);
  return(lastBest);
}

rb_red_blk_nodelist* RBTreeAsAscendingLinkedList(rb_red_blk_tree* tree)
{
    rb_red_blk_node* tmpNode = NULL;
    rb_red_blk_nodelist* tmpListNode = NULL;
    rb_red_blk_nodelist* linkedList = NULL;
    
    tmpNode = tree->root->left;
    while(tmpNode->right != tree->nil)
    {
        tmpNode = tmpNode->right;
    }
        
    while(tmpNode != tree->nil)
    {
        tmpListNode = malloc(sizeof(rb_red_blk_nodelist));
        tmpListNode->next = linkedList;
        tmpListNode->node = tmpNode;
        linkedList = tmpListNode;
        tmpNode = TreePredecessor(tree, tmpNode);
    }
    
    return linkedList;
}

rb_red_blk_nodelist* RBTreeAsDescendingLinkedList(rb_red_blk_tree* tree)
{
    rb_red_blk_node* tmpNode = NULL;
    rb_red_blk_nodelist* tmpListNode = NULL;
    rb_red_blk_nodelist* linkedList = NULL;
    ...
    while(tmpNode != tree->nil)
    {
        ...
        tmpListNode->node = tmpNode;
        linkedList = tmpListNode;
        tmpNode = TreeSuccessor(tree, tmpNode);
    }
